...
CREATE TABLE `cinsiyet` (
  `cinsiyet_id` binary(1) NOT NULL,
  `cinsiyet` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
INSERT INTO `cinsiyet` VALUES (_binary '0','Kız'),(_binary '1','Erkek');
