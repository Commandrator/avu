...
CREATE TABLE `borc` (
  `borc_no` int NOT NULL AUTO_INCREMENT,
  `sube_isim` varchar(25) NOT NULL,
  `borc_miktari` double NOT NULL,
  PRIMARY KEY (`borc_no`),
  KEY `sube_isim` (`sube_isim`),
  CONSTRAINT `borc_ibfk_1` FOREIGN KEY (`sube_isim`) REFERENCES `sube` (`sube_isim`)
