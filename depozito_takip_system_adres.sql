...
CREATE TABLE `adres` (
  ...
  `adres` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `note` text,
  PRIMARY KEY (`id`),
  KEY `iletisim_id` (`iletisim_id`),
  CONSTRAINT `adres_ibfk_1` FOREIGN KEY (`iletisim_id`) REFERENCES `iletisim` (`id`) ON DELETE CASCADE
...
INSERT INTO `adres` VALUES (1,NULL,'Ordu/Fatsa',NULL);
